...
parser.add_argument('dir', type=str, help='Directory where records are saved')  #対局データが保存されているフォルダ
parser.add_argument('--ratio', type=float, defaul=0.9, help="Proportion of records for train")  #訓練用データの割合
